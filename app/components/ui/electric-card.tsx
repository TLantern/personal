...
export type ElectricCardProps = {
  ...
  /** Description text. */
  description?: string;
  /** Show avatar image. Default is false. */
  showAvatar?: boolean;
  ...
  className?: string;
  /** Title position offset in pixels (e.g., -20 for 20px left). */
  titleOffset?: number;
};
...
const ElectricCard = ({
  ...
  const [ids, setIds] = useState({ swirl: "", hue: "" });
  ...
  const filterURL = ids.swirl && ids.hue
    ? variant === "hue"
      ? `url(#${ids.hue})`
      : `url(#${ids.swirl})`
    : "";

  if (!ids.swirl || !ids.hue) {
    return null;
  }
        ...
        <div className="content-container">
          {children ? (
            <div className="content-top">
              <div className="flex items-center justify-center gap-10 mb-4">
                ...
                <p className="title mb-0" style={titleOffset ? { marginLeft: `${titleOffset}px` } : undefined}>{title}</p>
              </div>
              {showAvatar && (
                <div className="avatar-container">
                  <div className="avatar">
                    <img src="/teni.png" alt="Avatar" />
                  </div>
                </div>
              )}
          ...
          <div className="content-top">
            <div className="flex flex-col items-center justify-center mb-4 w-full">
              <div className="scrollbar-glass mb-2">{badge}</div>
